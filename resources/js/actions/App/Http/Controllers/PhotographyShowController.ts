 ...
 */
    ...
    show.form = showForm
/**
* @see \App\Http\Controllers\PhotographyShowController::storeComment
 * @see app/Http/Controllers/PhotographyShowController.php:30
 * @route '/photography/{session}/comments'
 */
export const storeComment = (args: { session: string | { slug: string } } | [session: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/photography/{session}/comments'
 */
storeComment.url = (args: { session: string | { slug: string } } | [session: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { session: args }
    }
 ...
 * @route '/photography/{session}/comments'
 */
storeComment.post = (args: { session: string | { slug: string } } | [session: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: storeComment.url(args, options),
    method: 'post',
})
 ...
 * @route '/photography/{session}/comments'
 */
    const storeCommentForm = (args: { session: string | { slug: string } } | [session: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/photography/{session}/comments'
 */
        storeCommentForm.post = (args: { session: string | { slug: string } } | [session: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: storeComment.url(args, options),
            method: 'post',
        })
 ...
 */
    ...
    like.form = likeForm
const PhotographyShowController = { show, storeComment, like }

export default PhotographyShowController