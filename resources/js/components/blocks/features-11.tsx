                    ...
                    <Card className="group overflow-hidden shadow-black/5 sm:col-span-3 sm:rounded-none sm:rounded-tl-xl">
                        ...
                        <div className="relative h-fit pl-6 md:pl-12">
                            ...
                            <div className="bg-background overflow-hidden rounded-tl-lg border-l border-t pl-2 pt-2 dark:bg-zinc-950">
                                <img
                                    src="https://images.unsplash.com/photo-1611224923853-80b023f02d71?w=1207&h=929&fit=crop&crop=entropy&auto=format&q=75"
                                    className="hidden dark:block"
                                    alt="Advanced tracking system dark illustration"
                                    width={1207}
                                    height={929}
                                />
                                <img
                                    src="https://images.unsplash.com/photo-1557804506-669a67965ba0?w=1207&h=929&fit=crop&crop=entropy&auto=format&q=75"
                                    className="shadow dark:hidden"
                                    alt="Advanced tracking system light illustration"
                                    width={1207}
                                    height={929}
                                />
                            </div>
                            ...
                            <div className="relative mb-6 sm:mb-0">
                                ...
                                <div className="aspect-76/59 overflow-hidden rounded-r-lg border">
                                    <img
                                        ...
                                        className="hidden dark:block"
                                        alt="Asset locator dark illustration"
                                        width={1207}
                                        height={929}
                                    />
                                    <img
                                        ...
                                        className="shadow dark:hidden"
                                        alt="Asset locator light illustration"
                                        width={1207}
                                        height={929}
                                    />
                                </div>
