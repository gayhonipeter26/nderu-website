...
export const PhotoGallery = ({
  ...
  const photoVariants: any = {
    ...
    visible: (custom: { x: any; y: any; order: number }) => ({
      ...
      transition: {
        ...
        stiffness: 120, // Increased from 70 for snappier animation
        damping: 15, // Increased from 12 for less bounce
        mass: 0.8, // Reduced from 1 for faster movement
        delay: custom.order * 0.08, // Reduced from 0.15 for faster sequence
      },
    }),
  };
  ...
  return (
    <div className="mt-40 relative">
      ...
      Engineering Insights & Creative Perspectives
      </p>
      <h3 className="z-20 mx-auto max-w-2xl justify-center bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 bg-clip-text py-3 text-center text-4xl text-transparent dark:bg-gradient-to-r dark:from-slate-100 dark:via-slate-200 dark:to-slate-100 dark:bg-clip-text md:text-7xl">
        Digital <span className="text-rose-500"> Insights</span> & Stories
      </h3>
      <div className="relative mb-8 h-[350px] w-full items-center justify-center lg:flex">
        <motion.div
          ...
          transition={{ duration: 0.2, ease: "easeOut" }} // Reduced from 0.4 for faster fade-in
        >
          <motion.div
