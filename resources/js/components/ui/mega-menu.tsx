      ...
      >
        {items.map((navItem) => {
          ...
          return (
            ...
            >
              <button
                className={`relative flex cursor-pointer items-center justify-center gap-1 py-1.5 px-4 text-sm transition-colors duration-300 hover:text-white group ${active ? "text-white" : "text-white/50"
                  }`}
