    ...
    const animate = () => {
      ...
      for (let x = 0; x < width; x += 2) {
        for (let y = 0; y < height; y += 2) {
          ...
          // Purple-gray silk color with more transparency for B&W image
          const r = Math.floor(123 * intensity);
          const g = Math.floor(116 * intensity);
          const b = Math.floor(129 * intensity);
          const a = Math.floor(210 * intensity); // Reduced from 230 to 210 for B&W image
      ...
      // Add subtle overlay for depth with more transparency for B&W image
  ...
  return (
    <>
      ...
      <div className="relative h-screen w-full overflow-hidden bg-black">
        ...
        {/* Gradient Overlay - More transparent for B&W image */}
        ...
        <div className="relative z-20 flex h-full items-center justify-center">
          <div className="text-center px-8">
            ...
            >
              ...
              <span className="inline-block">photography</span>
              <span className="mx-4 text-gray-500">•</span>
