			...
			<div id="pricing" className="mx-auto w-full max-w-6xl space-y-5 px-4">
				...
				>
					<div className="flex justify-center">
						<div className="rounded-lg border px-4 py-1 font-mono">Services</div>
					</div>
					...
					<p className="text-muted-foreground mt-5 text-center text-sm md:text-base">
						Transparent pricing for software development and professional photography services. No hidden fees, just quality work.
					</p>
				</motion.div>
					...
					>	
						<div className="grid md:grid-cols-2 bg-background relative border p-4">
							...
							<div className="w-full px-4 pt-5 pb-4">
								<div className="space-y-1">
									<div className="flex items-center justify-between">
										<h3 className="leading-none font-semibold">Project-Based</h3>
										<div className="flex items-center gap-x-1">
											<span className="text-muted-foreground text-sm line-through">$2,999</span>
											<Badge variant="secondary">15% off</Badge>
										</div>
									</div>
									<p className="text-muted-foreground text-sm">Perfect for specific projects and one-time needs!</p>
								</div>
							...
							<div className="relative w-full rounded-lg border px-4 pt-5 pb-4">
								...
								<div className="space-y-1">
									<div className="flex items-center justify-between">
										<h3 className="leading-none font-semibold">Retainer</h3>
										<div className="flex items-center gap-x-1">
											<span className="text-muted-foreground text-sm line-through">$3,999</span>
											<Badge>25% off</Badge>
										</div>
									</div>
									<p className="text-muted-foreground text-sm">Ongoing support and development partnership!</p>
								</div>
								<div className="mt-10 space-y-4">
