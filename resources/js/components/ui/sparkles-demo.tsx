...
export function SparklesPreview() {
    return (
        <div className="flex h-full min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-black">
            <h1 className="relative z-20 text-center text-3xl font-bold uppercase tracking-[0.22em] text-white md:text-7xl lg:text-9xl">
                NDERU.KE
            </h1>
            <div className="relative h-52 w-[56rem] max-w-full">
                ...
                <div className="absolute inset-0 h-full w-full bg-black [mask-image:radial-gradient(480px_280px_at_center,transparent_14%,white)]" />
            </div>
        </div>
    );
}
